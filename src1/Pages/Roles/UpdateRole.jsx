      ...
      <div className="ml-5 mt-10 bg-white p-6 max-w-9xl rounded-xl shadow-xl">
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="bg-[var(--primary-color)] text-white hover:scale-105 active:scale-95 transition-transform duration-500 py-2 mt-6 text-sm px-4 rounded hover:bg-red-600"
