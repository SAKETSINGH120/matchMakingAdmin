  ...
  const fetchTermConditions = async () => {
    ...
    try {
      ...
      if (result.status) {
        ...
        setContent(result.data[0].termCondition);
      } else {
        ...
        {data && (
          <div className="mt-4">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 bg-gradient-to-l from-[#181e2a] to-[#232a3b] text-white rounded-lg font-semibold hover:bg-[#1F4926] transition-colors"
            >
              Save Changes
            </button>
          </div>
