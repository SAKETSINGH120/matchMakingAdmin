...
import {
  createPlacementApi,
  uploadPlacementCsv,
} from "../../Services/PlacementApi"; // Assuming a service file for placements
import { getAllcollage } from "../../Services/CollageApi,"; // Assuming the API is here
import toast from "react-hot-toast";
import Loader from "../../compoents/Loader";
import CsvFileUploader from "../../compoents/CsvFileUploader";
...
const CreatePlacement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await createPlacementApi(payload); // Send JSON directly
      if (res.status) {
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center gap-x-6">
          ...
          <CsvFileUploader
            file={file}
            setFile={setFile}
            templatePath="/excelTemplates/placement_template.csv"
            fileUploader={uploadPlacementCsv}
          />
        </div>
      </div>
