    ...
    <div className="theme-page m-3">
      ...
      <div className="theme-panel ml-5 mt-10 max-w-9xl p-6 shadow-xl">
        <form onSubmit={handleSubmit}>
          ...
          {formData.permissions.map((perm, index) => (
            <div key={index} className="mt-2 rounded-lg border border-theme-light-border p-4 transition-colors duration-200 dark:border-theme-dark-border">
              <div className="flex items-center justify-between">
                ...
                {formData.permissions.length > 1 && (
                  <button
                    ...
                    className="text-theme-light-danger transition-colors duration-200 hover:brightness-90 dark:text-theme-dark-danger"
                  >
                    Remove
                  </button>
                )}
          ...
          <button
            ...
            className="theme-btn-primary mt-4 rounded-xl py-2"
          >
            Add Permission
          </button>
